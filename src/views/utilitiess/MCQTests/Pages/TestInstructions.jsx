...
import { fetchMcqTopic, getMcqDataByRequest, getAllExpertiseLevels, getAllExperiences } from "views/API/MCATestApi";
...
const TestInstructions = () => {
  ...
  const testName = "MCQ Test Assessment";
    ...
    <MainCard>
      <Box sx={{ px: { xs: 1, md: 6 }, py: { xs: 3, md: 5 }, maxWidth: { xs: '100%', md: 1200 }, mx: 'auto' }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 4 }}>
          ...
          >
            Comprehensive skills assessment with AI-powered evaluation and detailed analysis
          </Typography>
        ...
        <Box sx={{ 
          ...
          {/* Left Panel - Skills Test Instructions */}
          <Card 
            elevation={0}
            sx={{ 
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2 }}>
                ...
                <Box>
                  ...
                  >
                    Complete the test within the allocated time - auto-submits when time ends
                  </Typography>
                </Box>
              </Box>
              ...
              <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2 }}>
                ...
                <Box>
                  ...
                  >
                    Allocate approximately 1 minute per question for optimal performance
                  </Typography>
                </Box>
              </Box>
              ...
              <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2 }}>
                ...
                <Box>
                  ...
                  >
                    Apply practical skills to solve real-world problems and scenarios
                  </Typography>
                </Box>
              </Box>
              ...
              <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2 }}>
                ...
                <Box>
                  ...
                  >
                    Review your answers with detailed explanations after submission
                  </Typography>
                </Box>
              </Box>
            </Box>
          ...
          >
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, alignItems: 'flex-start', width: '100%' }}>
              ...
              >
                ...
                >
                  Focus on practical skills and real-world application scenarios
                </Typography>
              ...
              {experienceLevels.length === 0 ? (
                ...
                experienceLevels.map((exp) => (
                  <MenuItem key={exp.experienceId} value={exp.experienceId}>
                    {exp.experienceName || exp.levelName || exp.name}
                  </MenuItem>
                ))
              )}
            </Select>
        ...
        <Grid container spacing={2} justifyContent="center">
          <Grid item>
            ...
            >
              {isLoading ? "Loading..." : "Start Your Test"}
            </Button>
          </Grid>
          <Grid item>
            <Button
