...
const AcademicTest = () => {
    ...
    const testName = "Academic Test Assessment";
        ...
        <MainCard>
            <Box sx={{ px: { xs: 1, md: 6 }, py: { xs: 3, md: 5 }, maxWidth: { xs: '100%', md: 1200 }, mx: 'auto' }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 4 }}>
                    ...
                    >
                        Comprehensive academic assessment with AI-powered evaluation and detailed analysis
                    </Typography>
                ...
                <Box sx={{ 
                    ...
                    {/* Left Panel - Academic Test Instructions */}
                    <Card 
                        elevation={0}
                        sx={{ 
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2 }}>
                                ...
                                <Box>
                                    ...
                                    >
                                        Apply theoretical knowledge to solve complex academic problems
                                    </Typography>
                                </Box>
                            </Box>
                    ...
                    >
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, alignItems: 'flex-start', width: '100%' }}>
                            ...
                            >
                                ...
                                >
                                    Focus on core academic concepts and theoretical foundations
                                </Typography>
