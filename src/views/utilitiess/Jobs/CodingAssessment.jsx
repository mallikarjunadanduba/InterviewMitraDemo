...
const codingCards = [
  {
    ...
    description: 'Unlock your problem-solving superpowers with algorithmic thinking that turns complex challenges into elegant solutions.',
    actionLabel: 'Start Coding Practice',
    path: '/jobs/coding-academic-practice',
    color: '#2563EB',
    image: academicImage,
  ...
  {
    title: 'Up Skills',
    subtitle: 'Build Like a Boss',
    description: 'Create amazing applications with industry-grade skills that make you the developer everyone wants to hire.',
    actionLabel: 'Start Coding Practice',
  ...
  return (
    <MainCard>
      <Box sx={{ px: { xs: 1, md: 6 }, py: { xs: 3, md: 5 }, maxWidth: { xs: '100%', md: 1200 }, mx: 'auto' }}>
        ...
        >
          Choose your Coding Preparation Path
        </Typography>
