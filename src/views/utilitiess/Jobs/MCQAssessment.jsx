...
const mcqCards = [
  {
    ...
    description: 'Build rock-solid foundations with core technical concepts that form the backbone of every successful tech career.',
    actionLabel: 'Start MCQ Practice',
  ...
  {
    title: 'Up Skills',
    subtitle: 'Industry-Ready Excellence',
    description: 'Level up with cutting-edge technologies and real-world scenarios that top companies actually use.',
    actionLabel: 'Start MCQ Practice',
  ...
  return (
    <MainCard>
      <Box sx={{ px: { xs: 1, md: 6 }, py: { xs: 3, md: 5 }, maxWidth: { xs: '100%', md: 1200 }, mx: 'auto' }}>
        ...
        >
          Choose your MCQ Preparation Path
        </Typography>
